  ...
  return (
    <div className="flex min-h-screen flex-col">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <ScrollReveal>
              <div className="flex flex-col justify-center space-y-8">
                <div className="inline-flex items-center rounded-full border border-[#0e5c2a]/20 bg-white/80 backdrop-blur-sm px-4 py-2 text-sm font-medium text-[#0e5c2a] shadow-sm">
                ...
                <div className="space-y-6">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-[#0e5c2a]">
                    ...
                    <span className="relative inline-block">
                      texnologik
                      <span className="absolute bottom-2 left-0 w-full h-3 bg-[#0e5c2a]/10 -z-10 transform -rotate-1"></span>
                    </span>
                    salohiyatingizni ochib bering.
                  </h1>
                  <p className="max-w-[600px] text-gray-600 md:text-xl">
                    Bugungi texnologiya sohasida kerak bo'ladigan ko'nikmalarni o'zlashtirishga mo'ljallangan keng
            ...
            <ScrollReveal delay={0.3}>
              <div className="relative mx-auto w-full max-w-[320px] md:max-w-[550px]">
                ...
                <div className="absolute -top-4 -right-4 bg-white rounded-lg shadow-xl p-3 animate-pulse-slow">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <ScrollReveal>
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              <div className="inline-flex items-center rounded-full border border-[#0e5c2a]/20 bg-white px-4 py-2 text-sm font-medium text-[#0e5c2a] shadow-sm">
                <span className="flex h-2 w-2 rounded-full bg-[#0e5c2a] mr-2"></span>
              ...
              <div className="space-y-4 max-w-3xl">
                ...
                <p className="text-gray-600 md:text-xl/relaxed">
                  It Brain'da biz haqiqiy dunyo muammolariga tayyorlanish uchun amaliy tajriba va sanoat yetakchi
          ...
          <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-2 lg:grid-cols-3">
            <ScrollReveal delay={0.1}>
              <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl hover:-translate-y-2 duration-500">
                <div className="absolute top-0 right-0 h-24 w-24 bg-[url('/feature-bg-1.jpg')] bg-cover rounded-bl-full opacity-20 transition-all group-hover:opacity-30"></div>
                <div className="relative z-10">
                  <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-[#e6f7e9] text-[#0e5c2a] transition-transform group-hover:scale-110 duration-300">
                    <BookOpen className="h-8 w-8" />
                  </div>
                  <h3 className="mb-4 text-xl font-bold text-[#0e5c2a]">Ekspert o'quv dasturi</h3>
                  <p className="text-gray-600">
                    Joriy bozor talablari va texnologiyalarga mos keladigan sanoat ekspertlari tomonidan ishlab
                    chiqilgan kurslar.
                  </p>
                </div>
              </div>
            ...
            <ScrollReveal delay={0.2}>
              <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl hover:-translate-y-2 duration-500">
                <div className="absolute top-0 right-0 h-24 w-24 bg-[url('/feature-bg-2.jpg')] bg-cover rounded-bl-full opacity-20 transition-all group-hover:opacity-30"></div>
                <div className="relative z-10">
                  <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-[#e6f7e9] text-[#0e5c2a] transition-transform group-hover:scale-110 duration-300">
                  ...
                  <p className="text-gray-600">
                    Yaxshiroq o'quv natijalari uchun har bir guruhda cheklangan talabalar soni bilan shaxsiy e'tibor.
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3}>
              <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl hover:-translate-y-2 duration-500 md:col-span-2 lg:col-span-1">
                <div className="absolute top-0 right-0 h-24 w-24 bg-[url('/feature-bg-3.jpg')] bg-cover rounded-bl-full opacity-20 transition-all group-hover:opacity-30"></div>
                <div className="relative z-10">
                  <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-[#e6f7e9] text-[#0e5c2a] transition-transform group-hover:scale-110 duration-300">
                  ...
                  <p className="text-gray-600">
                    Rezyumengizni va karyera istiqbollaringizni oshirish uchun sanoat tomonidan tan olingan
                    sertifikatlar.
                  </p>
                </div>
              </div>
      ...
      <section className="relative w-full py-24 md:py-32 lg:py-40" id="courses">
        <div className="absolute inset-0 bg-[url('/courses-bg.jpg')] bg-cover bg-fixed bg-center opacity-5"></div>
          ...
          <ScrollReveal>
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              ...
              <div className="space-y-4 max-w-3xl">
                ...
                <p className="text-gray-600 md:text-xl/relaxed">
                  IT sohasida muvaffaqiyatga erishishga yordam berish uchun mo'ljallangan keng qamrovli o'quv
          ...
          <ScrollReveal>
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              ...
              <div className="space-y-4 max-w-3xl">
                ...
                <p className="text-gray-600 md:text-xl/relaxed">
                  It Brain bilan karyeralarini muvaffaqiyatli o'zgartirgan bitiruvchilarimiz fikrlarini eshiting.
                </p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-center">
            <ScrollReveal>
              <div className="flex flex-col justify-center space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 md:text-xl/relaxed">
                    Kurslarimiz haqida savollaringiz bormi yoki tashrif buyurishni rejalashtirmoqchimisiz? Biz bilan
                    bog'laning va jamoamiz tez orada siz bilan bog'lanadi.
                  </p>
                </div>
                <div className="space-y-8 pt-4">
                  <div className="flex items-center gap-5">
                    <div className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#e6f7e9] text-[#0e5c2a]">
            ...
            <ScrollReveal delay={0.3}>
              <div className="relative">
                <div className="absolute inset-0 bg-[#0e5c2a] rounded-2xl blur-xl opacity-5 transform rotate-3"></div>
                <div className="relative rounded-2xl border border-[#e6f7e9] bg-white p-8 md:p-10 shadow-xl">
                  <ContactForm />
                </div>
              </div>
            </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="space-y-4 md:max-w-md">
                <h2 className="text-2xl md:text-3xl font-bold tracking-tighter text-white">Yangilanib turing</h2>
                <p className="text-[#e6f7e9] md:text-lg">
                  Eng so'nggi kurs yangiliklari, texnologiya yangiliklari va maxsus takliflar uchun bizning axborot
              ...
              <div className="w-full md:w-auto">
                ...
                <p className="mt-3 text-xs text-[#e6f7e9]/80">
                  Biz sizning maxfiyligingizni hurmat qilamiz. Istalgan vaqtda obunani bekor qilishingiz mumkin.
                </p>
              </div>
            </div>
          </ScrollReveal>
